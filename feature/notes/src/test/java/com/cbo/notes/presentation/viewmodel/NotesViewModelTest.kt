...
class NotesViewModelTest {
    ...
    fun setUp() = runBlocking {
        ...
        whenever(getNotesUseCase()).thenReturn(flowOf(dummyNotes))
        whenever(getCategoriesUseCase()).thenReturn(flowOf(dummyCategories))
        whenever(getTagsUseCase()).thenReturn(flowOf(dummyTags))
